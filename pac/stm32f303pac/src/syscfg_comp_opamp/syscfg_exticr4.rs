...
pub type R = crate::R<SyscfgExticr4Spec>;
#[doc = "Register `SYSCFG_EXTICR4` writer"]
pub type W = crate::W<SyscfgExticr4Spec>;
...
pub struct SyscfgExticr4Spec;
impl crate::RegisterSpec for SyscfgExticr4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`syscfg_exticr4::R`](R) reader structure"]
impl crate::Readable for SyscfgExticr4Spec {}
#[doc = "`write(|w| ..)` method takes [`syscfg_exticr4::W`](W) writer structure"]
impl crate::Writable for SyscfgExticr4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SYSCFG_EXTICR4 to value 0"]
impl crate::Resettable for SyscfgExticr4Spec {}
