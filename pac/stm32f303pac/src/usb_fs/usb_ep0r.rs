...
pub type R = crate::R<UsbEp0rSpec>;
#[doc = "Register `USB_EP0R` writer"]
pub type W = crate::W<UsbEp0rSpec>;
...
#[doc = "endpoint 0 register\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_ep0r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb_ep0r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UsbEp0rSpec;
impl crate::RegisterSpec for UsbEp0rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_ep0r::R`](R) reader structure"]
impl crate::Readable for UsbEp0rSpec {}
#[doc = "`write(|w| ..)` method takes [`usb_ep0r::W`](W) writer structure"]
impl crate::Writable for UsbEp0rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets USB_EP0R to value 0"]
impl crate::Resettable for UsbEp0rSpec {}
