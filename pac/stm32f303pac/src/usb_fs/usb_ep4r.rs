...
pub type R = crate::R<UsbEp4rSpec>;
#[doc = "Register `USB_EP4R` writer"]
pub type W = crate::W<UsbEp4rSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Endpoint address"]
    #[inline(always)]
    pub fn ea(&mut self) -> EaW<'_, UsbEp4rSpec> {
        EaW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Status bits, for transmission transfers"]
    #[inline(always)]
    pub fn stat_tx(&mut self) -> StatTxW<'_, UsbEp4rSpec> {
        StatTxW::new(self, 4)
    }
    #[doc = "Bit 6 - Data Toggle, for transmission transfers"]
    #[inline(always)]
    pub fn dtog_tx(&mut self) -> DtogTxW<'_, UsbEp4rSpec> {
        DtogTxW::new(self, 6)
    }
    #[doc = "Bit 7 - Correct Transfer for transmission"]
    #[inline(always)]
    pub fn ctr_tx(&mut self) -> CtrTxW<'_, UsbEp4rSpec> {
        CtrTxW::new(self, 7)
    }
    #[doc = "Bit 8 - Endpoint kind"]
    #[inline(always)]
    pub fn ep_kind(&mut self) -> EpKindW<'_, UsbEp4rSpec> {
        EpKindW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Endpoint type"]
    #[inline(always)]
    pub fn ep_type(&mut self) -> EpTypeW<'_, UsbEp4rSpec> {
        EpTypeW::new(self, 9)
    }
    #[doc = "Bits 12:13 - Status bits, for reception transfers"]
    #[inline(always)]
    pub fn stat_rx(&mut self) -> StatRxW<'_, UsbEp4rSpec> {
        StatRxW::new(self, 12)
    }
    #[doc = "Bit 14 - Data Toggle, for reception transfers"]
    #[inline(always)]
    pub fn dtog_rx(&mut self) -> DtogRxW<'_, UsbEp4rSpec> {
        DtogRxW::new(self, 14)
    }
    #[doc = "Bit 15 - Correct transfer for reception"]
    #[inline(always)]
    pub fn ctr_rx(&mut self) -> CtrRxW<'_, UsbEp4rSpec> {
        CtrRxW::new(self, 15)
    }
}
#[doc = "endpoint 4 register\n\nYou can [`read`](crate::Reg::read) this register and get [`usb_ep4r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb_ep4r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UsbEp4rSpec;
impl crate::RegisterSpec for UsbEp4rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb_ep4r::R`](R) reader structure"]
impl crate::Readable for UsbEp4rSpec {}
#[doc = "`write(|w| ..)` method takes [`usb_ep4r::W`](W) writer structure"]
impl crate::Writable for UsbEp4rSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets USB_EP4R to value 0"]
impl crate::Resettable for UsbEp4rSpec {}
