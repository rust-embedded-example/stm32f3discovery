...
pub struct Iog2crSpec;
impl crate::RegisterSpec for Iog2crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`iog2cr::R`](R) reader structure"]
impl crate::Readable for Iog2crSpec {}
#[doc = "`reset()` method sets IOG2CR to value 0"]
impl crate::Resettable for Iog2crSpec {}
